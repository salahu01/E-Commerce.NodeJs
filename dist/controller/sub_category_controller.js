...
const getAllSubCategories = (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const subCategories = yield sub_category_model_1.default.find();
        res.json({
            success: true,
...
const getOneSubCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const _id = new mongodb_1.ObjectId(req.params.id);
        const subCategory = yield sub_category_model_1.default.findOne({ _id });
        res.json({
            success: true,
